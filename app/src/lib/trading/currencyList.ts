...
export const tokenCurrenciesAllNetwork = [
  ...
  new Token(6, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', ChainId.MAINNET, 'USDC'),
  new Token(8, '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599', ChainId.MAINNET, 'WBTC'),
