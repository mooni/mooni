...
export default function StepNotice({ onComplete }) {
  ...
  return (
    <Box width={1}>
      <Hint>Please read carefully the following informations</Hint>
      <Title>Experimental software</Title>
      <Info>
        You are using an early stage software. If you encounter any bugs, you can reach out our support to find a
        solution.
      </Info>
      <Title>Transfer recipient</Title>
      <Info>
        You are supposed to send funds to a bank account you own. Do not send funds to a third party or a corporate
        account. All the exchanges done within this app are legally regulated under swiss laws, but you are responsible
        for your own tax fillings.
      </Info>
