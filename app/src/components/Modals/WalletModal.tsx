    ...
    <Dialog open={dialogOpen} maxWidth="sm">
      <Box p={1}>
        <Box display="flex" justifyContent="center" alignItems="center" flexDirection="column" width={1} p={2}>
          <Box width={1} mb={1} textAlign="center">
            <Title>
          ...
          <Box width={1} textAlign="center" my={1}>
            <Content>
              {walletStatus === WalletStatus.LOADING && "That'll be quick!"}
              {walletStatus === WalletStatus.WAITING_SIGNATURE && (
                <span>
                  We need to verify you are the owner of this address.
                  <br />
          ...
          {allowCancel && (
            <Button variant="outlined" color="secondary" size="small" onClick={() => dispatch(logout())}>
              Cancel
            </Button>
          )}
        </Box>
