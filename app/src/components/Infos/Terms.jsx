...
function Terms() {
  return (
    <Box pt={6} pb={6}>
      ...
      <Content>
        In order to improve the user experience and usabilty of the platform, the software may record some user activity on the website. These data are anonymised and does not contain any private informations. Such collected data can be: IP address, user agent, network requests, page views, user interactions, errors or order made through the app.
      </Content>
      <SubTitle>
        2.5 Referral system
      </SubTitle>
      <Content>
        ...
        <br/>
        The amount of profit share is currently set at {config.referralSharing * 100}% of the fees generated by referred users. This is a new and experimental feature, and may be subject to changes in the future.
        <br/>
